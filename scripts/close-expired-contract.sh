...
# A helper script for showing how to close an expired Active UTxO.
...
spendingRedeemerFile="${dir}closeExpired.json"

activeTokenName="416374697665" # This is the hexidecimal encoding for 'Active'

contractId="82653d2221932d287f69f5169b7b96e87866cceae698e4a4e8f4ba1b2030caa6"

writerStakingPubKeyFile="../assets/wallets/01Stake.vkey"

### Expiration slot for contract + 1.
### Make sure to add 1 to the expiration slot number.
expirationTime=$((27956685 + 1))
...
cardano-cli transaction build \
  --tx-in 4eb9dcf443c069103a8e5682daa070817936942110ed8fdf204b1ff1e8234bf0#0 \
