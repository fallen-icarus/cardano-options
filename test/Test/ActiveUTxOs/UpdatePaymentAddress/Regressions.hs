...
-------------------------------------------------
-- | Update the payment address for a single Active UTxO. The deposit does not increase.
...
-- | Update the payment address for a single Active UTxO. The deposit increases by 1 ADA.
          ...
          Output
            ...
            , outputDatum = OutputDatum $ toDatum $ 
                datum & #paymentAddress .~ newPaymentAddr
                      & #contractDeposit .~ contractDeposit + 1_000_000
            , outputReferenceScript = toReferenceScript Nothing
            }
      , withdrawals =
          [ Withdrawal
