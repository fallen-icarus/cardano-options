module Test.ProposalUTxOs.CreateProposal.Regressions where
...
-------------------------------------------------
-- | Create a single valid Proposal UTxO. The Proposal UTxO has only one possible `Terms`.
...
-- | Create a single valid Proposal UTxO. The Proposal UTxO has three possible `Terms`.
...
-- | Create multiple valid Proposal UTxOs. The Proposal UTxOs are all for different conditions, and
-- they all only have one possible `Terms`.
...
-- | Create multiple valid Proposal UTxOs. The Proposal UTxOs are all for different conditions. The
...
-- | Create multiple valid Proposal UTxOs that are stored at different writer addresses.
...
-- TestTree
-------------------------------------------------
-- | A `TestTree` containing all regression scenarios for creating Proposal UTxOs.
tests :: [TestTree]
tests =
