...
module Test.ActiveUTxOs.UpdatePaymentAddress.Benchmarks where
...
-- Benchmark Tests
-------------------------------------------------
-- | Update the payment address for multiple Active UTxOs. All Active UTxOs are for the same terms
-- and have the same beacons.
...
-- | Update the payment address for multiple Active UTxOs. All Active UTxOs are for different terms
-- and have different beacons.
...
-- TestTree
-------------------------------------------------
-- | A `TestTree` containing all benchmark scenarios for updating payment addresses.
tests :: [TestTree]
tests =
